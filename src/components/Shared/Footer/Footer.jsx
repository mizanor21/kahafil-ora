      ...
      <div className="container mx-5 lg:mx-auto py-10">
        <div className="grid row-gap-10 mb-8 lg:grid-cols-6">
          <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
            <div>
              <p className="font-bold tracking-wide text-black">Category</p>
            ...
            <div>
              <p className="font-bold tracking-wide text-black">Social Links</p>
              <ul className="mt-2 space-y-2">
                <li>
                  <Link
                    to="/"
            ...
            <div>
              <p className="font-bold tracking-wide text-black">Other</p>
              <ul className="mt-2 space-y-2">
                <li>
                  <Link
                    to="/"
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-sm text-black">
              ...
              Laboriosam, ad eveniet laudantium odit aperiam enim.
            </p>
          </div>
        </div>
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
          <p className="text-sm text-black">
            © Copyright 2024&nbsp;
            <Link
              className="link-hover text-green-700"
              target="_blank"
          ...
          <div className="flex items-center mt-4 space-x-4 sm:mt-0">
            <a
              href="https://web.facebook.com/kahafil.ora"
              target="_blank"
